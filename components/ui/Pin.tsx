...
export const PinContainer = ({
  ...
  const onMouseEnter = () => {
  setTransform("translate(-50%,-50%) rotateX(15deg) scale(0.8)");
};
  const onMouseLeave = () => {
  ...
  style={{
    perspective: "1000px",
    transform: "rotateX(30deg) translateZ(0deg)", // reduced from 70deg
  }}
...
export const PinPerspective = () => {
  ...
  style={{
    perspective: "1000px",
    transform: "rotateX(30deg) translateZ(0)", // reduced from 70deg
  }}
  className="absolute left-1/2 top-1/2 ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2"
>
